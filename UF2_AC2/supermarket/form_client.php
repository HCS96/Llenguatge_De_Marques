	...
	$textNif = "";
		...
		if(!empty($_POST)){
			...
			if((nomUsuariValid($usuari) == true) ){
				...
				$textUsuari = "<p style=\"color:red;\">Nombre de usuario incorrecto</p>";
			...
			if(seguretatContrasenya($contraseña) >= 3){
				...
				$textpass = "<p style=\"color:red;\">Seguridad de contraseña débil</p>";
			}
			...
			if ($contraseña == $repContraseña){
				...
				$textpass2 ="<p style=\"color:red;\">Las contraseñas no coinciden pisha</p>";
			}
			...
			if(NIFValid($nif) == true){
				...
				$textNif ="<p style=\"color:red;\">NIF invalido</p>";
			...
			if(esEmail($email) == true){
				...
				$textEmail ="<p style=\"color:red;\">eMail invalido</p>";
			}
